Surfaces.prototype.conus = (count = 40, color = '#00FFFF') => {
    ...
    /* Okowko
    polygons[61].visible = false;
    polygons[62].visible = false;
    polygons[63].visible = false;
    polygons[64].visible = false;
    polygons[polygons.length/2+1].visible = false;
    polygons[polygons.length/2+2].visible = false;
    polygons[polygons.length/2+3].visible = false;
    polygons[polygons.length/2+4].visible = false;
    */
    return new Subject(
